...
func IssueReportStatisticsToResponse(stats *domain.IssueReportStatistics) domain.IssueReportStatisticsResponse {
	response := domain.IssueReportStatisticsResponse{
		...
		Summary: domain.IssueReportSummaryStatisticsResponse{
			...
			OpenPercentage:          domain.NewDecimal2(stats.Summary.OpenPercentage),
			ResolvedPercentage:      domain.NewDecimal2(stats.Summary.ResolvedPercentage),
			AverageResolutionTime:   domain.NewDecimal2(stats.Summary.AverageResolutionTime),
			...
			AverageReportsPerDay:    domain.NewDecimal2(stats.Summary.AverageReportsPerDay),
