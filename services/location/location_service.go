...
type LocationService interface {
	...
	// * QUERY
	GetLocationsPaginated(ctx context.Context, params query.Params, langCode string) ([]domain.LocationResponse, int64, error)
	GetLocationsCursor(ctx context.Context, params query.Params, langCode string) ([]domain.LocationResponse, error)
